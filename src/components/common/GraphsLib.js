...
const CircleGraph = ({width = 239, height = 239, itemsCount = 4, category = 'software'}) => (
  <svg className={`graph ${category}-graph`} xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 239 239">
    <defs>
      ...
      <path id="developement-path" fill="#FF4326" fillOpacity=".3" stroke="#FF4326" strokeWidth="6" d="M119.657,17.5 c49.843,0,117.217,101.619,87.218,153.132c-21.994,37.768-48.541,20.368-87.874,20.701c-39.333,0.334-70.419,11.664-86.876-20.918 s13.21-54.082,28.21-85.082C75.335,54.334,86.313,17.5,119.657,17.5z"/>
    </defs>
